...
import static ru.job4j.pools.completablefuture.GoToTrash.goToTrash;

/** пример использования supplyAsync*/
public class GoToShop {
    ...
    public static void main(String[] args) throws Exception {
        /**GoToShop.supplyAsyncExample();*/
        /**GoToShop.thenAcceptExample();*/
        /**GoToShop.thenApplyExample();*/
        /**GoToShop.thenComposeExample();*/
        /**GoToShop.thenCombineExample();*/
        /**GoToShop.allOfExample();*/
        GoToShop.anyOfExample();
    }
}
